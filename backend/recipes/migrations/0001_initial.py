    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(help_text='Цветовой код должен быть в 16-ричном формате. Например: #49B64E', max_length=7, validators=[django.core.validators.RegexValidator(code='wrong_hex_code', message='Цвет должен быть в 16-ричном формате.', regex='^#[a-fA-F0-9]{6}$')], verbose_name='Цвет')),
                ('slug', models.SlugField(help_text='Введите slug тега', unique=True, verbose_name='URL метка')),
            ],
            options={
                'verbose_name': 'Tег',
